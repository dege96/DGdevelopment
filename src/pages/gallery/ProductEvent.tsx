...
const ProductEvent = () => {
  ...
  const gallery: GalleryItem[] = [
    { 
      ...
      description: "Högkvalitativ produktfotografering med kontrollerad belysning för optimalt resultat." 
    },
    { 
      image: placeholderUrls[1], 
      title: "Eventfotografering", 
      description: "Dokumentation av företagsevent med fokus på nyckelmoment och interaktioner." 
    },
    { 
      image: placeholderUrls[2], 
      title: "Teknisk presentation", 
      description: "Visuell presentation av tekniska produkter för marknadsföringsmaterial." 
    },
    { 
      image: placeholderUrls[3], 
      title: "Produktdetalj", 
      description: "Närbild på produktdetaljer för teknisk dokumentation och produktkataloger." 
    },
  ];
      ...
      <section className="section-padding bg-secondary/10">
        <div className="container mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="heading-lg mb-6 animate-slideDown opacity-0" style={{ animationDelay: '0.2s' }}>Produkt & Event</h1>
            <p className="max-w-3xl mx-auto text-white/70 mb-8 animate-slideDown opacity-0" style={{ animationDelay: '0.4s' }}>
              Exempel på våra produkt- och eventfotografier
            </p>
